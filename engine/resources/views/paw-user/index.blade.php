        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
                ...
                <div class="col-md-11 ftco-animate text-center">
                    <h1 class="mb-4" style="font-size: 48px;">Taking Care For Your Smart Pet's !</h1>
                    <h1 class="mb-4" style="font-size: 20px;">Human-canine bonding is the relationship between pets and
                        humans</h1>
                    <a href="{{ route('pawcare.dash') }}" class="btn btn-primary bg-gradient">Gradient</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body">
                            ...
                            <p>Providing pet owners with the information necessary to care for and monitor their pets'
                                health.</p>
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body">
                            ...
                            <p>Giving pet owners easy and reliable access to plan daily or long-term care for their beloved
                                pets</p>
                            <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span
                                    class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
                        </div>
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body">
                            ...
                            <p>A facility designed to make it easier for pet owners to care for and maintain the cleanliness
                                of their pets</p>
                            <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span
                                    class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a>
                        </div>
                    ...
                    <div class="carousel-testimony owl-carousel ftco-owl">
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                ...
                                <div class="text">
                                    <p class="mb-4">I absolutely love this Paw Care app! It's user-friendly and has
                                        everything I need to keep track of my pet's health. The reminders for vaccinations
                                        and appointments are a lifesaver.
                                        Highly recommend!</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                <div class="icon d-flex align-items-center justify-content-center"><span
                                        class="fa fa-quote-left"></span></div>
                                <div class="text">
                                    <p class="mb-4">I love the reminders for vaccinations and grooming appointments. The
                                        only improvement I suggest is adding more customization options for the pet
                                        profiles. Otherwise, it's been very helpful in keeping my pet's schedule organized.
                                    </p>
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                <div class="icon d-flex align-items-center justify-content-center"><span
                                        class="fa fa-quote-left"></span></div>
                                <div class="text">
                                    <p class="mb-4">Overall, a great app for managing pet care tasks. I love the
                                        reminders for vaccinations and grooming appointments. The only improvement I suggest
                                        is adding more customization options for the pet profiles.</p>
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                <div class="icon d-flex align-items-center justify-content-center"><span
                                        class="fa fa-quote-left"></span></div>
                                <div class="text">
                                    <p class="mb-4">Fantastic app! I use it to schedule walks for my dog, and the GPS
                                        tracking feature ensures he's getting enough exercise. The in-app community is a
                                        nice touch too – I can connect with other pet owners and share tips.</p>
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="item">
                            <div class="testimony-wrap py-4">
                                <div class="icon d-flex align-items-center justify-content-center"><span
                                        class="fa fa-quote-left"></span></div>
                                <div class="text">
                                    <p class="mb-4">I appreciate the app's simplicity and how it covers all the basics.
                                        It helps me keep track of my cat's feeding schedule. However, it would be nice to
                                        see additional features like a pet health tracker or integration with vet clinics.
                                    </p>
                                    <div class="d-flex align-items-center">
